...
<head>
    ...
    <title>Sistema Escolar - Home Aluno</title>
...
<body>
    ...
    <div style="padding-left:50px; padding-right:50px;">
        ...
        <nav class="menu">
            <a href="/PI/telas/home/homealuno.php">INÍCIO</a>
            ...
            <a href="/PI/telas/meucurso/meucurso.php">MEU CURSO</a>
            <a href="/PI/telas/minhaturma/minhaturma.php">MINHA TURMA</a>
            <a href="/PI/telas/meusprofessores/meusprofessores.php">MEUS PROFESSORES</a>
    ...
    <main>
        <div style="text-align: center; padding: 20px;">
            ...
            <p>Acompanhe suas notas, faltas, materiais didáticos e informações do seu curso através do menu acima.</p>
        </div>
    </main>
